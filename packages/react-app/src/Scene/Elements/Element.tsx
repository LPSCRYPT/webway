...
const [transform, setTransform] = useState<{
  ...
  useEffect(() => {
    ...
    const positionVector = position ? new Vector3(position.x, position.y, position.z) : undefined;
    const rotationVector = rotation ? new Vector3(rotation.x, rotation.y, rotation.z) : undefined;
    const scaleVector = scale ? new Vector3(scale.x, scale.y, scale.z) : undefined;
